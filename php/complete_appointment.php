    ...
    if ($result->num_rows > 0) {
        ...
        if ($update_stmt->execute()) {
            ...
            try {
                ...
                $mail->Password = 'vgpy fagc vbyp nkyc'; // Use an app password for security
                ...
                $mail->Body = "Hello $username,<br><br>
                               Your appointment has been marked as completed. Here are the details:<br>
                               <strong>Machine:</strong> $machine_name<br>
                               <strong>Date and Time:</strong> $appointment_date<br><br>
                               Thank you for visiting us! We hope you had a great experience.<br><br>
                               Regards,<br>FabLab CTU Danao Team";

                $mail->send();
                $_SESSION['success_message'] = "Appointment marked as completed, and confirmation email sent to the user.";
            } catch (Exception $e) {
